...
class OnboardingPagePhone extends HookConsumerWidget {
  const OnboardingPagePhone({
    super.key,
            ...
            onPressed: isFormValid.value
                ? () async {
                    ...
                    if (result) {
                      ...
                      const errorMessage =
                          'מתנצלים, אבל לא זיהינו את מספר הנייד הזה.\nייתכן שהתבלבת באחד התווים, או שנרשמת ממספר אחר.';
                      // ignore: use_build_context_synchronously
                      onFailure?.call(context, errorMessage);
